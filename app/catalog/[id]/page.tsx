  ...
  return (
    <div className="min-h-screen bg-neutral-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <Link
          href="/catalog"
          className="inline-flex items-center text-neutral-600 hover:text-blue-600 mb-8 transition-colors"
        >
            ...
            <div className="p-8 lg:p-12">
              ...
              <div className="mb-8">
                <p className="text-sm text-neutral-500 uppercase tracking-wide mb-1">
                  {car.type === "RENT" ? "Preço da Diária" : "Preço de Venda"}
                </p>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="São José dos Campos - SP">
                  ...
                  <div className="pt-4 border-t border-neutral-200">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="text-2xl font-bold text-neutral-900">
                        R${" "}
                        {(car.price * 0.0005 * days).toLocaleString("pt-BR", {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                        })}
                      </span>
                  ...
                  <div className="space-y-4 bg-yellow-50 p-6 rounded-2xl border border-yellow-100">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={startDate}
                        onChange={(e) => setStartDate(e.target.value)}
                        className="w-full px-4 py-2 rounded-lg border border-neutral-300 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                        min={new Date().toISOString().split("T")[0]}
                      />
                    </div>
                    ...
                    <button
                      onClick={async () => {
                        if (!startDate || !time)
                          return alert("Escolha data e hora.");

                        try {
                         const visitDate = new Date(`${startDate}T${time}:00`);
                          ...
                          const res = await fetch("/api/visits", {
                            ...
                            body: JSON.stringify({
                              carId: car.id,
                              userId: user?.id, // ou pegue do contexto de autenticação
                              date: visitDate.toISOString(), // string ISO 8601
                            }),
